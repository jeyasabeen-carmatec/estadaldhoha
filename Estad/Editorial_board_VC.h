...
@interface Editorial_board_VC : UIViewController <CollapseClickDelegate, UITableViewDataSource, UITableViewDelegate,UISearchBarDelegate>
{
...
@property (nonatomic, strong) IBOutlet UITableView *tbl_editors;
