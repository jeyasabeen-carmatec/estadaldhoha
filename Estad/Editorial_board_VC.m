...
@interface Editorial_board_VC ()

@end

@implementation Editorial_board_VC
{
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    else if (tableView == _tbl_editors)
    {
        return [name count];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        static NSString *simpleTableIdentifier = @"SimpleTableCell";
        Editorial_BRD_cell *cell = (Editorial_BRD_cell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
        if (cell == nil)
        {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (tableView == _list_DATA)
    {
        ...
        if ([model_Name isEqualToString:@"News"])
        {
            ...
            controller.get_Editorial = @"Editorial";
