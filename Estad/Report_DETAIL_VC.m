...
@implementation Report_DETAIL_VC

@synthesize get_ID;

@synthesize get_home,get_Article,get_About_US,get_Editorial,get_Emagazine,get_ontact_US;
@synthesize get_Article_TITL,get_News_titl,get_Photo_titl,get_Video_titl,get_titl;
...
-(void) setup_VIEW
{
    ...
    NSDictionary *news = [temp_dictin valueForKey:@"Report"];
...
//    NSRange sttr = [dtail rangeOfString:data];
//    [attributedText setAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"HelveticaNeue" size:14.0]
//                                    ,
